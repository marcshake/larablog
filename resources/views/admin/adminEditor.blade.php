        ...
        <div class="field">
            ...
            <div class="control">
                <input autocomplete="false" class="input u-full-width" type="text" placeholder="{{ __('headline') }}"
                    value="{{ $contents->title }}" name="title" id="title">
            </div>
        </div>
        <div class="field">
            <label class="label" for="description">{{ __('shortdescription') }}</label>
            <div class="control">
                <input autocomplete="false" class="input u-full-width" type="text" id="description"
                    value="{{ $contents->description }}" name="description" maxlength="255">
            </div>
        </div>
            ...
            <div class="row">
                <div class="four columns">
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input u-full-width" type="text" name="tags" id="tags"
                ...
                <div class="four columns">
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input u-full-width" type="text" name="kategorie" id="kategorie"
